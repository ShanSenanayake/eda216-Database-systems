  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
		...
		<br>
		<select class="form-control" name="cookieName" size=10>
		<?php
			$first = true;
	...
	<br>
    <input class="form-control" type="text" size="20" name="nbrPallets" >
    <input  class="btn btn-default" type="submit" value="Create Batch">
</form>
      </div>
